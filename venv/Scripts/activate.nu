...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Steven_Yates_i3\Documents\Tweet Analyzer\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Steven_Yates_i3\Documents\Tweet Analyzer\venv\Scripts\deactivate.nu'
